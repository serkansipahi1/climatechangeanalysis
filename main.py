...
# Load the data
data = pd.read_excel("C:/Users/alper/OneDrive/Masaüstü/Yeni klasör/climatechangeanalysis/climatechangedata(1).xlsx")
...
# Model Parameters (consistent across variables)
input_size = 1
hidden_size = 128
num_layers = 2
output_size = 1
